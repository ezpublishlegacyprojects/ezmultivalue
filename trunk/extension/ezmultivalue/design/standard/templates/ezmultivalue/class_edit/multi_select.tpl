...
<tr>
    ...
    <td><input type="text" name="name_{$option['@Id']}" value="{$option['@name']|wash}" /></td>
    <td><input type="text" name="value_{$option['@Id']}" value="{$option['@value']|wash}" /></td>
...
<label><input type="radio" name="type" value="list" {cond( eq( $field.Options.0['@type'], 'checkbox' )|not, 'checked="checked"', '' )} />{'List'|i18n( 'ezmultivalue/edit_class_field' )}</label>
<label><input type="radio" name="type" value="checkbox" {cond( eq( $field.Options.0['@type'], 'list' )|not, 'checked="checked"', '' )} />{'Checkbox'|i18n( 'ezmultivalue/edit_class_field' )}</label>
</div>
